    ...
    return Column(
      ...
      children: [
        FeedbackActionTile(
          ...
          onTap: () {
            context.push(RoutePaths.studentDossier, extra: {
              'firstName': involvedPerson.name,
              'secondName': involvedPerson.surname,
              'className': involvedPerson.className,
              'photoUrl': involvedPerson.photoUrl,
            });
          },
          leading: AdaptiveUserAvatar(
            imageUri: involvedPerson.photoUrl == 'https://example.com/photo.jpg'
                ? 'https://cdn.pixabay.com/photo/2018/09/11/19/49/education-3670453_1280.jpg'
                : involvedPerson.photoUrl!,
          ),
