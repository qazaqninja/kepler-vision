...
class _$ForgotPasswordRequestImpl implements _ForgotPasswordRequest {
  const _$ForgotPasswordRequestImpl({required this.usernameOrEmail});
  ...
  @override
  String toString() {
    return 'ForgotPasswordRequest(usernameOrEmail: $usernameOrEmail)';
  }
...
abstract class _ForgotPasswordRequest implements ForgotPasswordRequest {
  const factory _ForgotPasswordRequest(
      {required final String usernameOrEmail}) = _$ForgotPasswordRequestImpl;
