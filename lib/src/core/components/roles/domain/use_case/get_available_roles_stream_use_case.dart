...
@lazySingleton
class GetAvailableRolesStreamUseCase
    extends NoneInputStreamUseCase<List<RoleEntity>> {
  final IRolesRepository _repository;

  GetAvailableRolesStreamUseCase(this._repository);

  @override
  Future<Stream<Either<DomainException, List<RoleEntity>>>> execute() async{
    return _repository.availableRolesStream.map((e) => Right(e));
  }
}
